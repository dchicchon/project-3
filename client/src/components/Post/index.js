...
function Post(props) {
  return (
    ...
    <Col size="s6">
      <div class="card">
        ...
        <div class="card-image">
          <img src="https://images.unsplash.com/photo-1564694230688-f6afe64db816?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=634&q=80" width="300" height="350" class="activator" />
    ...
    I am convenient because I require little markup to use effectively.</p>
          ...
          <div class="card-reveal">
            <p class="card-title">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Recusandae perferendis debitis nobis asperiores! Ipsam facilis autem in libero architecto aut quisquam eos adipisci ipsum soluta. Error quidem nobis natus impedit!</p>
          </div>
